<?php
	...
	// query database to retrieve poster titles for diplaying in drop down
...
<div id = "divouter" class = "div-outer">
	...
	<div id = "divformsellmain" class = "div-form-sell-main">
		...
		<div id = "divsellpostersheader" class = "div-sellbooks-header">				
			<label class = "text-bold">Sell Poster(s)</label>
			<br/> <br/>
			<label class = "text-small">(All fields are required)</label>						
		</div>
		
		<form id = "formsellbooks" class = "form-sell" method = "post" action = "http://linux.students.engr.scu.edu/~sdoshi/EnchantedPress/php/SubmitSell.php?functionName=sellPosters">	
		
			<label>POSTER DETAILS</label>
								
			<div id = "divbookdetails" class = "div-details">
				<div id = "div-form-sell-inner1" class = "div-form-sell-inner">			
					<label class = "text-form-sellposters1">Poster Title</label>
				...
				<div id = "div-form-sell-inner2" class = "div-form-sell-inner">	
					<label class = "text-form-sellposters2">Quantity</label>
			...
			<br />	
			<div id = "div-form-sell-inner5" class = "div-form-sell-inner">	
				<input id = "buttonsellposter" type = "submit" value = "Submit" class = "button-sell"></input> 
			</div>
		</form>
